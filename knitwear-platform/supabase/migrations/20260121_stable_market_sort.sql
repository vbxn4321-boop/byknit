-- Stable Marketplace Sorting Fix
-- Previous version had (random() * 20) in recommended score, causing list shuffle on every fetch.
-- Also added tie-breaker ordering.
...
BEGIN
        ...
        (
            CASE
                ...
                ELSE -- 'recommended'
                    ...
                    -- Removed random() factor to ensure stable sorting
            END
    ...
    ORDER BY score DESC, p.id DESC -- Added tie-breaker
